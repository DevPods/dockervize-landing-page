...
const Privacy = () => {
  ...
  const privacyContent = 'At DockerVize, accessible at DockerVize.com, one of our main priorities is the privacy \
  ...
  const consentContent = 'By using our website, you hearby consent to our Privacy Policy and agree to its terms.';
  const informationTitle = 'Information we collect';
  const informationContent = 'The personal information that you are asked to provide, and the reasons why you are asked \
