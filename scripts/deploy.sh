...
docker tag dockervize/dev:latest 114736952595.dkr.ecr.us-east-1.amazonaws.com/dockervize-landing:$TRAVIS_COMMIT
# Push built image to ECS
docker push 114736952595.dkr.ecr.us-east-1.amazonaws.com/dockervize-landing:$TRAVIS_COMMIT
